...
=====================================
生成:
  figures/q0_preprocess.png  原始SOH(含AR(1)噪声+容量再生尖刺) vs 平滑趋势 soh_t 对比
  figures/q1_resistance.png  内阻随循环增长曲线(按温度着色, 双对数下近似线性)
运行: python paper/code/preprocess_figs.py
"""
